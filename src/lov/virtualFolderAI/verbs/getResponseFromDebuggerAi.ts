// lnov/virtualFolder/ai/verbs/getResponseFromDebuggerAi.ts

import { GoogleGenerativeAI, ChatSession, GenerateContentResult } from '@google/generative-ai';
import { Dependencies } from '../../../utils/types/dependencies';

/**
 * Sends a prompt to the AI model and retrieves the response for debugging tasks.
 ...
 * @example
 * ```typescript
 * const response = await virtualFolderAi.getResponseFromDebuggerAi('Debug this code');
 * console.log('AI Response:', response);
 * ```
 *
 * @category VirtualFolderAI
 */
export default function getResponseFromDebuggerAi(d: Dependencies) {
